...
CFLAGS_NOERROR = $(INCLUDE) -O3 -g -Wall -std=c++14 -Wno-unused-variable -D X64 -Wno-deprecated -Wno-deprecated-declarations
CFLAGS = $(CFLAGS_NOERROR) -Werror

#For MAC, -D MACOS should be included
CFLAGS1= $(INCLUDE) -O1 -g -Wall -std=c++14 -Wno-unused-variable -D X64 -Wno-deprecated -Wno-deprecated-declarations
CC=g++
LINK=g++
