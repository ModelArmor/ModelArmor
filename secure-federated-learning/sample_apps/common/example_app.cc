...
// --- FL runner flags ---
DEFINE_string(workdir, "/root/secure-federated-learning/sample_apps/simple_app/FL-IDS",
...
DEFINE_string(venv_path, "/root/secure-federated-learning/sample_apps/simple_app/FL-IDS/venv/bin/activate", "Path to venv activate script (e.g., /path/to/venv/bin/activate). Optional");
DEFINE_string(server_script, "/root/secure-federated-learning/sample_apps/simple_app/FL-IDS/federated/binary/server.py", "Server script filename");
DEFINE_string(client_script, "/root/secure-federated-learning/sample_apps/simple_app/FL-IDS/federated/binary/client.py", "Client script filename");
DEFINE_string(dataset_dir, "/root/secure-federated-learning/sample_apps/simple_app/FL-IDS/federated/federated_datasets", "Directory containing dataset files for client script");
